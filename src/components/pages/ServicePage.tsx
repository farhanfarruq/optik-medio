...
export function ServicesPage() {
    return (
        <>
            ...
            {/* Menggunakan background 'layanan-pattern' */}
            <div className="bg-layanan-pattern bg-cover bg-center min-h-[60vh] flex items-center">
                <Container className="py-16 text-center">
                    <div className="bg-white/70 backdrop-blur-sm p-12 rounded-2xl shadow-soft">
                        <h1 className="text-4xl font-bold text-neutral-900">Layanan Kami</h1>
